...
public class Graph<T> implements GraphADT<T>
{
     ...
     * Uses removeVertex(index) to actually remove the vertex once found
     *
    ...
    public Iterator<T> iteratorDFS(int startIndex)
    {
        Integer x;
        boolean found;
        StackADT<Integer> traversalStack = new LinkedListStack<Integer>();
    ...
    {
        Integer x;
        QueueADT<Integer> traversalQueue = new LinkedListQueue<Integer>();
        UnorderedListADT<T> resultList = new ArrayUnorderedList<T>();
                                        ...
                                        (int startIndex, int targetIndex)
    {
        ...
        StackADT<Integer> stack = new LinkedListStack<Integer>();
        index = targetIndex;
    ...
    public Graph getMST()
    {
        int x, y;
        int[] edge = new int[2];
        StackADT<int[]> vertexStack = new LinkedListStack<int[]>();
    ...
    public boolean isConnected()
    {
		...
		int counter = 0;
		Iterator<T> iterate = iteratorBFS(0);
    ...
    {
		Object[] newVertices = new Object[numVertices];
		Object vertex;
